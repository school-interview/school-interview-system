        ...
        <div class="mx-auto mt-3 text-center" style="width:600px;">
          ...
          <v-dialog v-model="dialog" persistent width="300">
            <v-card height="190" class="text-center">
              <v-container class="mx-auto d-flex align-center justify-center">
                <v-progress-circular :indeterminate="isLoading" :size="100" color="primary" class="mt-4 ">Loading...
                </v-progress-circular>
              </v-container>
            </v-card>
          </v-dialog>
          ...
          <v-col cols="12">
            <v-card color="#f8f8ff" theme="dark">
              <div class="d-flex flex-no-wrap justify-space-between">
                ...
                <v-card-actions>
                  <v-btn class="ma-2" variant="outlined" width="100" height="75" color="white"
                    style="font-weight: bold;background-color: #2552da;" @click="startvideo">動画を<br>表示する
            ...
            <v-card color="#f8f8ff" theme="dark">
              <div class="d-flex flex-no-wrap justify-space-between">
                ...
                <v-card-actions>
                  ...
                  <v-btn class="ma-2" variant="outlined" width="100" height="75" color="white"
                    style="font-weight: bold;background-color: #d3872f;" @click="startvideo2">動画を<br>表示する
            ...
            <v-card color="#fff8dc" theme="dark">
              <div class="d-flex flex-no-wrap justify-space-between">
                <div>
                  ...
                  <v-card-title
                    :class="{ 'color-black': sum >= 0 && sum <= 4, 'color-orange': sum >= 5 && sum <= 6, 'color-red': sum >= 7 && sum <= 10 }">
                    要支援レベル：{{ sum }}</v-card-title>
                  <v-card-text class="text-h8">週当たりの平均欠席科目数：{{ data.absent }} GPA：{{ data.gpa
                    }}<br>学生生活の分析：{{ reason }}</v-card-text>
