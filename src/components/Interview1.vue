  ...
  <v-app id="inspire">
    <v-app-bar flat>
      <v-container class="mx-auto d-flex align-center justify-center">
        ...
        <v-btn v-if="res" color="red" class="text-h5 font-weight-bold" @click="() => $router.push({ name: 'other'})">面談終了</v-btn>
        <v-btn v-if="!res" :color="buttonAColor" @click="firstQuestion" class="text-h5 font-weight-bold">{{ buttonALabel }}</v-btn> 
      ...
      <v-container>
        <v-row>
          ...
          <video ref="videoPlayer" width="800" height="450" @ended="restartVideo">
            <source :src="currentVideo === 'Wait' ? videoWait : videoQues" type="video/mp4"></video>
          ...
          <v-card color="rgb(255, 255, 255, 0.3)" width="500" height="75"><p class="text-h6 font-weight-bold">質問：{{ currentText }}</p></v-card></div>
          ...
          <v-btn :disabled="!this.isButtonOn" :color="speechBtnColor" @click="startSpeechBtn">{{ speechtxt }}</v-btn>
