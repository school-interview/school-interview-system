...
class DefaultApi {
  ...
  /// Controller
  Future<TeachersResponse?> controllerTeachersGet() async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'TeachersResponse',) as TeachersResponse;
